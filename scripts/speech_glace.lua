--[[
	--- This is Glace's speech file for Don't Starve Together ---
]]
return {
	ACTIONFAIL =
	{
		REPAIR =
        {
            WRONGPIECE = "Oh, no... It does not fit together...",
        },
		BUILD =
        {
            MOUNTED = "I would fall down.",
            HASPET = "I am not greedy. One is enough!",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "No... Now would be too dangerous.",
			GENERIC = "That wouldn't work...",
			NOBITS = "There is nothing left.",
		},
		STORE =
		{
			GENERIC = "No space left.",
			NOTALLOWED = "I can't put that there.",
			INUSE = "I'll try again later.",
		},
		RUMMAGE =
		{
        ...
        COOK =
        {
            GENERIC = "That can't be cooked.",
            INUSE = "There is already someone cooking.",
			TOOFAR = "I can't reach that far!",
        },
        GIVE =
        {
            DEAD = "It's dead. It can't carry stuff.",
            SLEEPING = "Sleeping... maybe i should, too.",
            BUSY = "I'll just wait a bit",
        },
        GIVETOPLAYER =
        {
        	FULL = "Their pockets are already saturated!",
            DEAD = "It's a ghost. It can't carry stuff.",
            SLEEPING = "Sleeping... maybe i should, too.",
            BUSY = "I have stuff for you. Don't ignore me.",
    	},
    	GIVEALLTOPLAYER =
        {
					FULL = "Their pockets are already saturated!",
		...
		WRITE =
        {
            GENERIC = "No modification needed.",
            INUSE = "Let's see what they come up with first!",
        },
        DRAW =
        {
            NOIMAGE = "I am missing something here?",
        },
        CHANGEIN =
        {
            GENERIC = "It's cold, i do not want to change my clothes now.",
            BURNING = "Well, at least it would warm me up!",
            INUSE = "That would be rude.",
        },
        ATTUNE =
        {
            NOHEALTH = "I feel too faint right now.",
        },
        MOUNT =
        {
            TARGETINCOMBAT = "That would not end well!",
            INUSE = "Nothing i can do. They where first.",
        },
        SADDLE =
        {
            TARGETINCOMBAT = "It's too angry right now.",
        },
        TEACH =
        {
            --Recipes/Teacher
            KNOWN = "I learned that yesterday.",
            CANTLEARN = "Too complicated.",

            --MapRecorder/MapExplorer
            WRONGWORLD = "What does that mean? It's all wrong...'",
        },
        WRAPBUNDLE =
        {
            EMPTY = "I need some contents first.",
        },
	},
	ACTIONFAIL_GENERIC = "I can't do that..... Yet.",
	ANNOUNCE_ADVENTUREFAIL = "That didn't go well. I'll have to try again.",
	ANNOUNCE_BEES = "The Apis mellifera are coming!",
	ANNOUNCE_BOOMERANG = "Ow! Right in the eye!",
	ANNOUNCE_CHARLIE = "I think i hear someone... or something.",
	ANNOUNCE_CHARLIE_ATTACK = "OW! That really hurt!",
	ANNOUNCE_COLD = "I hate the cold...",
	ANNOUNCE_HOT = "That does not make sense. I am the cold!",
	ANNOUNCE_CRAFTING_FAIL = "It seems I am missing a part.",
	ANNOUNCE_DEERCLOPS = "That sounds like bad news!",
	ANNOUNCE_DUSK = "It will be dark soon. Where are my friends?",
	ANNOUNCE_EAT =
	{
		GENERIC = "That tasted quite well.",
		PAINFUL = "Urgh, that hurt my stomach!",
		SPOILED = "Yuck! That was terrible!",
		STALE =   "One more day and that would have ended bad!",
		INVALID = "I can't eat that!",
		YUCKY = "Puting that in my mouth would be disgusting!",
	},
	ANNOUNCE_ENTER_DARK = "Click. And the light is gone.",
	ANNOUNCE_ENTER_LIGHT = "I can see again!",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "I can feel my brain getting bigger!",
	ANNOUNCE_HOUNDS = "Ack! I don't have time for that!",
	ANNOUNCE_HUNGRY = "I'm starving...",
	ANNOUNCE_HUNT_BEAST_NEARBY = "A fresh track, the pray must be near!",
	ANNOUNCE_HUNT_LOST_TRAIL = "Strange, that was the last one.",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "Curse the rain! The tracks don't hold.",
	ANNOUNCE_INV_FULL = "Any more and it hurts my back!",
	ANNOUNCE_KNOCKEDOUT = "Ugh, my head!",
	ANNOUNCE_LOWRESEARCH = "I didn't learn very much from that.",
	ANNOUNCE_MOSQUITOS = "Way to ruin the day!",
	ANNOUNCE_NODANGERSLEEP = "It's too noisy to sleep!",
	ANNOUNCE_NODAYSLEEP = "Maybe when it's later.",
	ANNOUNCE_NODAYSLEEP_CAVE = "I don't want to sleep here.",
	ANNOUNCE_NOHUNGERSLEEP = "Not yet, first I need to fill my stomach.",
	ANNOUNCE_NOSLEEPONFIRE = "Well, I guess it would be warm at least.",
	ANNOUNCE_NODANGERSIESTA = "It's too noisy to sleep!",
	ANNOUNCE_NONIGHTSIESTA = "If I do that I would probably freeze to death.",
	ANNOUNCE_NONIGHTSIESTA_CAVE = "Sleeping? Not here.",
	ANNOUNCE_NOHUNGERSIESTA = "Maybe after a meal.",
	ANNOUNCE_NODANGERAFK = "Sometimes you must fight!",
	ANNOUNCE_NO_TRAP = "Well, that was easy.",
	ANNOUNCE_PECKED = "Iiih! Not the eyes!",
	ANNOUNCE_QUAKE = "Presents from above?",
	ANNOUNCE_RESEARCH = "Inventing for survival!",
	ANNOUNCE_SHELTER = "This tree is better than nothing.",
	ANNOUNCE_THORNS = "Ow! Right through the shoes!",
	ANNOUNCE_BURNT = "Finally some warmth.",
	ANNOUNCE_TORCH_OUT = "Oh no! My light!",
	ANNOUNCE_TRAP_WENT_OFF = "Oh! That wasn't on purpose!",
	ANNOUNCE_UNIMPLEMENTED = "OW! I don't think it's ready yet.",
	ANNOUNCE_WORMHOLE = "I saw things I didn't want to see.",
	ANNOUNCE_CANFIX = "\nI'm sure that's fixable!",
	ANNOUNCE_ACCOMPLISHMENT = "I did well, I guess.",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "If only my friends could see me now...",
	ANNOUNCE_INSUFFICIENTFERTILIZER = "Still not enough?",
	ANNOUNCE_TOOL_SLIP = "That slits right through my fingers.",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "That would've been bad!",

	ANNOUNCE_DAMP = "That's liquid ice.",
	ANNOUNCE_WET = "Am I getting wet, or frozen?",
	ANNOUNCE_WETTER = "This rain is annoying.",
	ANNOUNCE_SOAKED = "There should be a limit to this. I'm soaked!",

	ANNOUNCE_BECOMEGHOST = "The afterlife is calling.",
	ANNOUNCE_GHOSTDRAIN = "I feel a ghostly presence.",

	DESCRIBE_SAMECHARACTER = "It's too cold for both of us.",

	BATTLECRY =
	{
		GENERIC = "Go for the ice!",
		PIG = "Just drop your meat!", --TODO
		PREY = "Let me hug you with my cold dead hands...",
		SPIDER = "I'm going to stomp you dead!", --TODO
		SPIDER_WARRIOR = "Better you than me!", --TODO
	},
	COMBAT_QUIT =
	{
		GENERIC = "Yeah... maybe another time.",
		PIG = "Be glad I am not that hungry!",
		PREY = "It doesn't want a hug...",
		SPIDER = "He's too gross, anyway.", --TODO
		SPIDER_WARRIOR = "Shoo, you nasty thing!", --TODO
	},
	DESCRIBE =
	{
        PLAYER =
        {
            GENERIC = "My friend %s.",
            ATTACKER = "%s is quite aggressive today.",
            MURDERER = "Murderer!",
            REVIVER = "%s, friend of ghosts.", --TODO
            GHOST = "%s could use a heart.", --TODO
        },
		WILSON =
		{
			GENERIC = "It's Wilson!",
		...
		MULTIPLAYER_PORTAL = "A one way ticket.",
		GLOMMER = "Gross.",
		GLOMMERFLOWER =
		{
			GENERIC = "It stinks.",
		...
		GLOMMERWINGS = "They are disgusting.",
		GLOMMERFUEL = "Why did i pick this up?",
		BELL = "Come forth, you destroyer of worlds (and trees)!",
		STATUEGLOMMER =
		{
			GENERIC = "Not an ice statue.",
			EMPTY = "It shattered like ice.",
		},
		...
		MOLE =
		{
			HELD = "Your fate is in my hands.",
			UNDERGROUND = "Something's under there, searching for minerals.",
			ABOVEGROUND = "Don't let them deceive you. They're thieves!",
		},
		MOLEHILL = "I bet it's warm in there...",
		...
		BATBAT = "It's sharp! I bet I could fly if I held two of these.",	-- Duplicated
		BEARDHAIR = "Disgusting.",
		BEARGER = "What a bear of a badger.",
		BEARGERVEST = "Welcome to hibernation station!",
		ICEPACK = "Just like my body.",
		--TODO end of Version 1.0
